"use strict";(self.webpackChunkgatsby_starter_hello_world=self.webpackChunkgatsby_starter_hello_world||[]).push([[670],{2454:function(M,I,i){i.p},2761:function(M,I,i){i.d(I,{D:function(){return n}});var N=i(6540),g=i(3467),D=i(999),e=i(1612);const j="@media (max-width: 800px)",T=i(5042).Fr?12:18,l=g.A.hr`
  width: 100%;
...
`,n=u.A.div`
  ...
  /* stars image */
  background: url(${e.A}) center / contain no-repeat;
...
`,z=(0,u.A)(T.Pf)`
  ...
  margin: 8px auto 0;
  opacity: 0.9;
`;I.default=M=>{let{data:I,pageContext:i}=M;const{0:g,1:e}=(0,N.useState)(-1),l=I.allContentfulProjectCaseStudy.nodes;return N.createElement(D.A,null,N.createElement(m.A,{metaTitle:"Nova | Our Work"}),N.createElement(c,null,N.createElement(T.bi,{y:64}),N.createElement(n,null),N.createElement(T.Zk,null,N.createElement(y,null,N.createElement(o,{center:!0},"Our Work"),N.createElement(w,{center:!0},"Take a look at some of the projects we are working on now or have worked on in the past. Whether they're web development, mobile development, data science, or design, our solutions have been able to serve a wide variety of nonprofits."," "),N.createElement(d,null,(I.allContentfulProjectCaseStudy.nodes||[]).filter(M=>M.featured).slice(0,3).map((M,I)=>{var i,g,D;console.log(M);const e=null==M||null===(i=M.preview)||void 0===i||null===(g=i.localFile)||void 0===g?void 0:g.publicURL,j=(null===(D=M.description)||void 0===D?void 0:D.description)||"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam elementum maximus risus ut.";return N.createElement(A,{key:M.id,to:`/work/${M.slug}`},N.createElement(L,{src:e}),N.createElement(Z,null,M.name),N.createElement(z,null,j))})),N.createElement(T.bi,{y:24})),N.createElement(T.bi,{y:144}),N.createElement(T.vg,null,"... and more!"),N.createElement(T.bi,{y:36}),N.createElement(j.D,null,l.filter(M=>!M.featured&&!M.inProgress).map((M,I)=>N.createElement(j.A,{data:M,idx:I,open:g===I,onClick:()=>{e(g===I?-1:I)}})))),N.createElement(T.bi,{y:144})))}},7747:function(M,I,i){i(6540),i(999);var N=i(3467);i(6525),i(5980),i(2619),i.p,i(9847),i(7430),i.p,i(2449),i(5042);const g="@media (max-width: 800px)";N.A.div`
  height: 65vh;
  width: 100%;
  position: relative;
  display: flex;
