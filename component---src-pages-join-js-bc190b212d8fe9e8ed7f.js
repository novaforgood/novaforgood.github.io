"use strict";(self.webpackChunkgatsby_starter_hello_world=self.webpackChunkgatsby_starter_hello_world||[]).push([[791],{927:function(e,M,t){t.p},2761:function(e,M,t){t.d(M,{D:function(){return r}});var i=t(6540),I=t(3467),l=t(999),N=t(1612);const n="@media (max-width: 800px)",g=t(5042).Fr?12:18,o=I.A.hr`
  width: 100%;
...
`;function r(e){let{children:M}=e;return i.createElement(i.Fragment,null,i.createElement(c,null,i.createElement(T,null,"PARTNER"),i.createElement(T,null,"PROJECT DESCRIPTION")),M,i.createElement(o,null))}M.A=e=>{let{data:M,onClick:t,open:I,idx:n}=e;const{name:c,description:T,slug:r}=M;return i.createElement("div",null,i.createElement(o,null),i.createElement(l.bi,{y:12}),i.createElement(a,null,i.createElement(j,null,i.createElement("b",null,c)),i.createElement(u,null,i.createElement(l.Pf,null,T&&T.description)),i.createElement(D,null,i.createElement(l.pp,{to:`/work/${r}`},i.createElement(N.EQc,{size:g})))),i.createElement(l.bi,{y:12}))}},3428:function(e,M){Object.defineProperty(M,"__esModule",{value:!0}),M.default=function(e,M,t){var i=void 0,I=void 0,l=void 0,N=void 0,n=void 0,g=function g(){var o=+new Date-N;o<M&&o>=0?i=setTimeout(g,M-o):(i=null,t||(n=e.apply(l,I),i||(l=null,I=null)))};return function(){l=this,I=arguments,N=+new Date;var o=t&&!i;return i||(i=setTimeout(g,M)),o&&(n=e.apply(l,I),l=null,I=null),n}}},4567:function(e,M){Object.defineProperty(M,"__esModule",{value:!0}),M.default=function(e,M,t){var i,I;return M||(M=250),function(){var l=t||this,N=+new Date,n=arguments;i&&N<i+M?(clearTimeout(I),I=setTimeout(function(){i=N,e.apply(l,n)},M)):(i=N,e.apply(l,n))}}},5539:function(e,M,t){t.r(M);var i=t(3467),I=t(6540),l=(t(8669),t(7186)),N=t(9580),n=t(6489),g=t(6691),o=t(3711),a=t(6448),j=t(4605),u=t(8821),D=t(2852),c=(t(927),t(999)),T=(t(2761),t(9945));const r="@media (max-width: 800px)",d=(i.A.div`
  margin: 0 auto;
  max-width: 700px;
  ${r} {
    max-width: 500px;
...
`,i.A.div`
  ...
  position: relative;
  text-align: center;
  background-image: url(${j.A}), url(${l.A}), url(${u.A}),
    url(${N.A}), url(${n.A}), url(${a.A}),
    url(${l.A}), url(${j.A});
